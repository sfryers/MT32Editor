namespace MT32Edit
{
    public class Patch
    {
        ...
        private string[] timbreGroupType = { "Preset A", "Preset B", "Memory", "Rhythm" };
        private string[] assignModeType = { "Single Assign", "Multi Assign", "First In, First Out", "First In, Last Out" };
